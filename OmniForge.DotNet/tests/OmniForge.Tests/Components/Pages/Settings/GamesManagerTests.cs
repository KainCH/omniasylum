...
public class GamesManagerTests : BunitContext
{
    ...
    public GamesManagerTests()
    {
        ...
        ComponentFactories.AddStub<GameLibraryManager>();
    }

    [Fact]
    public void ManagedStreamer_AsAdmin_PassesTargetUserIdToGameLibraryManager()
    {
        // Arrange
        ...
        var cut = Render(b =>
        {
            ...
            {
                builder.OpenComponent<GamesManager>(2);
        ...
        var stub = cut.FindComponent<Bunit.TestDoubles.Stub<GameLibraryManager>>();
